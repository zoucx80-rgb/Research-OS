...
def test_public_v1_5_02_version_and_core_api_are_consistent():
    ...
    assert RESEARCH_OS_VERSION == "1.5.2"
    assert research_os.__version__ == "1.5.2"
    assert project["project"]["version"] == "1.5.2"
    assert metadata["research_os_version"] == "1.5.2"
    ...
    assert metadata["module_versions"]["semantic_research_view"] == "1.0.0"
    assert ResearchViewPresenter.version == "semantic-research-view@1.0.0"
