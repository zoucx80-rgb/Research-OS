...
class DistributorPack:
    pack_id="distributor"; pack_version="distributor@1.1.0"; formula_version="distributor-core@1.1.0"
    ...
    def calculate(self,f):
        ...
        vals={
            ...
            "dpo_days":dpo,
            "ccc_days":ccc,
            "inventory_turns":safe_ratio(f.get("cogs"),f.get("avg_inventory")),
