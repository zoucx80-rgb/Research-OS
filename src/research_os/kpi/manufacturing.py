...
class ManufacturingPack:
    ...
    pack_version = "manufacturing@1.0.0"
    ...
    def calculate(self, f):
        ...
        period_reason = "PERIOD_LENGTH_REQUIRED" if resolve_period_days(period) is None else None
        d = dupont(
            f.get("revenue"),
        ...
        period_sensitive = {"ar_days", "inventory_days"}
        return [
            MetricResult(
                metric_id=k,
                value=v,
