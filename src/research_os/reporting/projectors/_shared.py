...
_STATUS_LABELS = {
    ...
    "RESEARCH_SUFFICIENCY_BLOCKED": "研究充分性门槛未通过",
    "FORECAST_CONFIRMATION_REQUIRED": "预测基准尚未形成确认",
    "QUANTITATIVE_FUNDING_BRIDGE": "定量融资桥接支持该判断",
    ...
    "EXPERIMENT_NOT_PROVIDED": "未提供预测实验",
    "INSUFFICIENT_OBSERVATIONS": "预测观察样本不足",
    "UNREGISTERED_BENCHMARK": "预测基准未注册",
    "HYPOTHESIS_NOT_PREREGISTERED": "预测假设未预注册",
    "OOS_BENCHMARK_MISSING": "缺少样本外基准验证",
    "REGISTERED_BENCHMARK_MISSING": "缺少已注册预测基准",
    "PIT_COMPLIANCE_FAILED": "预测回测未通过时点一致性检查",
    "FORECAST_METRICS_INCOMPLETE": "预测评估指标不完整",
    "STABILITY_EVIDENCE_MISSING": "缺少跨窗口稳定性证据",
    "all promotion gates passed": "全部晋级门槛均已通过",
    "ACTIVE": "当前有效",
    "DEBT_FUNDED": "债务融资驱动",
    "SELF_FUNDED": "内部现金流支持",
    "STRESSED": "融资压力较高",
...
_DIMENSION_LABELS = {
    ...
    "funding_loop": "融资循环",
    "thesis_portfolio": "投资逻辑组合",
    "forecast_quality": "预测质量",
    "valuation_reconciliation": "估值模型协调",
    "valuation_market_gap": "估值市场差额",
    "scenario": "敏感性情景",
    "research_sufficiency": "研究充分性",
...
_MODEL_LABELS = {
    ...
    "pb": "PB",
    "ev_ebitda": "EV/EBITDA",
    "naive:last_value": "最近一期值",
    "naive:historical_mean": "历史均值",
}
...
_ARTIFACT_META: dict[str, tuple[str, str]] = {
    ...
    "decision.input_assessment": ("decision", "决策输入评估"),
    "decision.derivation": ("decision", "决策推导"),
    ...
    "forecast.benchmark_evidence": ("expectation", "预测基准证据"),
    "peers.normalized": ("valuation", "同行可比性"),
    "valuation.routing": ("valuation", "估值方法与适用性"),
    "valuation.execution": ("valuation", "估值模型结果"),
    "valuation.market_anchor": ("valuation", "PIT 市场锚"),
    "valuation.market_gap": ("valuation", "市场价格与模型区间"),
