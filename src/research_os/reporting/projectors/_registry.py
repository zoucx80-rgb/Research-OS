...
from ._market import (
    ...
    _valuation_market_anchor,
    _valuation_market_gap,
...
_PROJECTORS: dict[str, Callable[[dict[str, Any]], JsonValue]] = {
    ...
    "valuation.market_anchor": _valuation_market_anchor,
    "valuation.market_gap": _valuation_market_gap,
...
def _substantive(artifact_id: str, data: dict[str, Any]) -> bool:
    ...
    checks = {
        ...
        "valuation.market_anchor": ("price", "security_id"),
