...
REQUIRED=("v1_golden","pit","manufacturing","distributor","router_explainable","thesis_falsifiers","ledger","valuation_fitness","decision_no_trade","snapshot_reproducible")
