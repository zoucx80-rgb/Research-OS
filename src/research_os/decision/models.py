...
ResearchDecisionState=Literal["HIGH_CONVICTION_WATCH","ACCUMULATION_CANDIDATE","WAIT_FOR_CONFIRMATION","HOLD_AND_MONITOR","RISK_REVIEW","THESIS_BROKEN","INSUFFICIENT_EVIDENCE"]
